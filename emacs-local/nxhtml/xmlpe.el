...
;; Last-Updated: Tue May 02 00:27:07 2006 (7200 +0200)
;; Keywords: languages
...
(defun xmlpe-mode-start()
  ...
  (make-variable-buffer-local 'xmlpe-header-footer-name)
  (make-variable-buffer-local 'xmlpe-invisible-hf)
  (make-variable-buffer-local 'xmlpe-started)
  (make-variable-buffer-local 'xmlpe-header-overlay)
  (make-variable-buffer-local 'xmlpe-footer-overlay)
  (make-variable-buffer-local 'xmlpe-base-overlay)
  (make-variable-buffer-local 'xmlpe-base-href-overlay)
  (make-variable-buffer-local 'xmlpe-css-overlay)
  (make-variable-buffer-local 'xmlpe-css-href-overlay)
